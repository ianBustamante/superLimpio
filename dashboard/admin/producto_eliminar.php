...
function productoTieneVentas($conn, $idProducto) {
  // Si existe al menos una línea en detalleventa, no se permite eliminar
...
// --- POST: Confirmación y eliminación ---
$mensaje = ''; $tipo = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  // doble verificación de relación con ventas
  if (productoTieneVentas($conn, $id)) {
    ...
    if (eliminarProductoBD($conn, $id)) {
      registrarEvento($conn, $_SESSION['idUsuario'], 'Producto - Eliminar', 'Exitoso', "Producto #$id eliminado.");
